    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="flex-1 space-y-6">
        {type === 'create' && (
          ...
          <p className="text-dark-700">Request a new appointment date</p>
        </section>
        )}
        {type !== "cancel" && (
          <>
            ...
            <div className="flex flex-col gap-6 xl:flex-row">
                ...
                <CustomFormField fieldType={FormFieldType.TEXTAREA} control={form.control} name="note" label="Note" placeholder="Enter notes" />
            </div>
          </>
        )}
